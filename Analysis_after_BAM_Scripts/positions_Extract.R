...
#Depending on p-val method: changed
...
#write.csv(int_X, file='X_positions_meanP.csv', row.names = FALSE)
#write.csv(int_2L, file='2L_positions_meanP.csv', row.names = FALSE)
#write.csv(int_2R, file='2R_positions_meanP.csv', row.names = FALSE)
#write.csv(int_3L, file='3L_positions_meanP.csv', row.names = FALSE)
#write.csv(int_3R, file='3R_positions_meanP.csv', row.names = FALSE)
#write.csv(int_4, file='4_positions_meanP.csv', row.names = FALSE)
